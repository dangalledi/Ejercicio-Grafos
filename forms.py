...
class PostForm(FlaskForm):
    ...
    tarea = SelectField('Tarea: ', choices = [('actualizar','Actualizar grafo'),('agregar','Agregar arista al Grafo'),('corto','Mostrar camino más corto'),('flujo','Indicar el flujo máximo'),('hoe','Hamilton o Euler'),('arbol','Obtener Árbol Generador Mínimo'),('kruskal','Obtener Árbol (KRUSKAL)'),('hamiltoniano','Grafo hamiltoniano'),('euleriano','Grafo euleriano'),('conexo','Saber si es conexo')])
