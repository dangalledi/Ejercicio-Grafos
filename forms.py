...
class PostForm(FlaskForm):
    ...
    tarea = SelectField('Tarea: ', choices = [('actualizar','Actualizar grafo'),('agregar','Agregar arista al Grafo'),('corto','Mostrar camino más corto'),('flujo','Indicar el flujo máximo'),('hoe','Hamilton o Euler'),('kruskal','Obtener Árbol (KRUSKAL)'),('conexo','Saber si es conexo')])
